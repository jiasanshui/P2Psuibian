...
public class DEBJUtil {
    ...
    public static void main(String[] args) {
        double invest = 200000; // 本金
        int month = 20;
        double yearRate = 0.0275; // 年利率
